...
<div class="container">
    <nav class="navbar navbar-bg">
        ...
        <a href="attendance.html" class="nav-links">Attendance</a>
...
<section class="attendance text-center">
    ...
    <h2>
     ...
     <p>
        <i> Submit your details here.</i>
    </p>
    

    <form class="row g-3 needs-validation mg-top" action="register2.php" method="post">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="eventname" name="eventname"placeholder="Enter the event name you want to register for..." required>
            <div class="valid-feedback">
              Looks good!
            </div>
          </div>
        ...
        <div class="col-12">
          <button class="submit" type="submit" id="register" name="create">Register</button>
        </div>
        </div>
      </form>
		...
		$('#register').click(function(e){
			...
			var rollno 	= $('#rollno').val();
				...
				$.ajax({
					type: 'POST',
					url: 'process2.php',
					data: {firstname: firstname,lastname: lastname,course: course,eventname: eventname,rollno: rollno},
